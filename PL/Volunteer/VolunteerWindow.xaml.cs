...
namespace PL.Volunteer
{
    public partial class VolunteerWindow : Window, INotifyPropertyChanged
    {
        ...
        //    }
        //}
        private void HandleVolunteerUpdate1()
        {
            try
            {
                // טעינה מחדש של הנתונים על ה-UI thread
                Application.Current.Dispatcher.Invoke(() =>
                {
                    ...
                    // עדכון ה-Volunteer
                    Volunteer = updatedVolunteer;  // זה יפעיל את OnPropertyChanged ויעדכן את ה-UI אוטומטית
                });
            }
            catch (Exception ex)
            {
        ...
        private void HandleVolunteerUpdate2()
        {
            try
            {
                // טעינה מחדש של הנתונים על ה-UI thread
                Application.Current.Dispatcher.Invoke(() =>
                {
                    ...
                    Volunteer.Number_phone = updatedVolunteer.Number_phone; // הוספת עדכון מספר הטלפון
